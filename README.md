...
| 下载                                                                           | 说明                 |
| ------------------------------------------------------------------------------ | -------------------- |
| [GitHub Release v0.3.0](https://github.com/crazyjackab/cp/releases/tag/v0.3.0) | 推荐：在线下载安装包 |
| 仓库内 `updates/File Manager_0.3.0_x64-setup.exe`                              | 本地已构建的安装包   |

**v0.3.0 更新摘要**：收藏与标签、重复文件检测、操作日志、智能收纳提醒、系统托盘、PDF 预览、后台任务与批量操作、扩展名自定义规则等。

已安装 v0.2.0 及更早版本的用户可在 **设置 → 更新** 中自动升级到 v0.3.0（需 GitHub Release 已发布 `latest.json`）。
