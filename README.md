...
| 下载                                                                           | 说明                 |
| ------------------------------------------------------------------------------ | -------------------- |
| [GitHub Release v0.3.1](https://github.com/crazyjackab/cp/releases/tag/v0.3.1) | 推荐：在线下载安装包 |
| 仓库内 `updates/File Manager_0.3.1_x64-setup.exe`                              | 本地已构建的安装包   |

**v0.3.1 更新摘要**：资料库文件另存为（单文件与批量）、拖出到资源管理器/外部应用等。

已安装旧版的用户可在 **设置 → 更新** 中自动升级到 v0.3.1（需 GitHub Release 已发布 `latest.json`）。
