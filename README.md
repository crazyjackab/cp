...
| 下载 | 说明 |
|------|------|
| [GitHub Release v0.2.0](https://github.com/crazyjackab/cp/releases/tag/v0.2.0) | 推荐：在线下载安装包 |
| 仓库内 `updates/File Manager_0.2.0_x64-setup.exe` | 本地已构建的安装包 |

**v0.2.0 更新摘要**：库内搜索与筛选、图片缩略图网格、资料库路径/移动·复制设置、文档颜色区分与 UI 优化。

已安装 v0.1.0 的用户可在 **设置 → 更新** 中自动升级到 v0.2.0（需 GitHub Release 已发布 `latest.json`）。
